      ...
      <footer className="footer__1">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 space-y-20">
              <div className="footer__logo">
                <Link to="/">
                  <img src={`img/logos/Logo.png`} alt="logo" id="logo_js_f" />
                </Link>
              </div>
              <p className="footer__text">
              Akasha The futuristic NFT marketplace.
              </p>
              <div>
            ...
            <div className="col-lg-2 col-6">
              <h6 className="footer__title">Akasha</h6>
              <ul className="footer__list">
                <li>
                  <Link to="/forum">Forum & community</Link>
                </li>
                <li>
                  <Link to="home-2"> Blog</Link>
                </li>
                <li>
          ...
          <p className="copyright text-center">
            Copyright © 2021. Created with love by @EnnasryRida.
          </p>
        </div>
      </footer>
    </div>
